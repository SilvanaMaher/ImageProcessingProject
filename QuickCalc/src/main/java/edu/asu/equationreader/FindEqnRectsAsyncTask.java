...
import edu.asu.equationreader.imageProc.ImageProccessingService;

/**
 * An async task for finding rectangles (in particular, rectangles containing
 * mathematical expressions) in an image
 */
public class FindEqnRectsAsyncTask extends AsyncTask {
    ...
    private Bitmap bitmapBW; // the image in black and white

package edu.asu.equationreader;
...
import edu.asu.equationreader.camera.CameraConfigurationManager;

import static edu.asu.equationreader.imageProc.ImageProccessingService.NV21BytesToGrayScaleBitmap;
import static edu.asu.equationreader.imageProc.ImageProccessingService.locallyAdaptiveThreshold;
...
public class MainActivity extends Activity {
    ...
    public void handlePreviewFrame(byte[] data, Camera camera) {
        ...
        Point cameraResolution = configManager.getcResolution();
